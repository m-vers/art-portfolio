          ...
          <section className="py-10 max-w-screen-lg m-auto">
            <div>
              <h3 className="text-5xl py-2 bg-gradient-to-r from-blue-600
                  to-purple-500 bg-clip-text text-transparent font-roboto font-black dark:text-blue-400 md:text-6xl max-w-xl pl-4">The ReAnimator</h3>
            ...
            <div className="flex flex-col gap-10 py-10 items-center">
              <div >
                <video autoPlay muted loop><source src="/TheReAnimator18.mp4" type="video/mp4"/></video>
              </div>
            </div>
          </section> 
        </section>
