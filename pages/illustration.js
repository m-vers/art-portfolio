          ...
          <nav className="py-10 mb-12 justify-between flex dark:text-blue-100">
            ...
            <div>
              <h3 className="text-5xl py-2 bg-gradient-to-r from-blue-600
                  to-purple-500 bg-clip-text text-transparent font-roboto font-black dark:text-blue-400 md:text-6xl max-w-sm pl-4">Illustration</h3>
            </div>
              ...
              <div className="basis-1/3 flex-1 relative">
                <Link href="./components/AppreciateDay">
                  <Image
                    ...
                    alt=""
                  />
                  <div className="cursor-pointer absolute bottom-0 left-0 bg-blue-900 w-full h-1/3 text-white bg-opacity-60 flex items-center justify-center font-sarabun text-3xl hover:h-full transition-[height] xsmall:pb-3 xsmall:h-1/2">
